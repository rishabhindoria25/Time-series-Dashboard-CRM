...
import PrdadminhomeEditablerow from './PrdadminhomeEditablerow';
...
function Prdadminhome({ isAuthenticated, error, clearErrors }) {
...
export default connect(mapStateToProps)(Prdadminhome);