...
export const AreaChart = ({AChart}) => {
 ...
 const [ChartName, setChartName] = useState('AChart') 
 ...
 const fetchPrices = async() => {
  ...
  const body = {
    ...
    password:"PasswordMustBeDifficultToGuess",
        ...
        keys: AChart.Keys, 
        starttime: AChart.StartTime,
      endtime: AChart.EndTime,
        }
...
const Cid=AChart.Cid;
const DeleteChart = () => { 
  console.log("Clickeed")
  console.log(AChart.Cid)
