    ...
    <div className="overlay-scrollbar" id='body'>
          ...
          <div className="sidebar">
            ...
            <li className="sidebar-nav-item" >
              ...
              <li className="sidebar-nav-item">
                <Link to="/customer/department" className="sidebar-nav-link">
                  <div>
              ...
              <li className="sidebar-nav-item">
                <Link to="/customer/distributor" className="sidebar-nav-link active">
                  <div>
...
export default CustomerDistributor