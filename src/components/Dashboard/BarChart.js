...
export const BarChart = ({BChart}) => {
 ...
 const [ChartName, setChartName] = useState('BChart') 
 ...
 const fetchPrices = async() => {
  ...
  const body = {
    ...
    password:"PasswordMustBeDifficultToGuess",
        ...
        keys: BChart.Keys, 
        starttime: BChart.StartTime,
      endtime: BChart.EndTime,
        }
...
const Cid=BChart.Cid;
const DeleteChart = () => { 
  console.log("Clickeed")
  console.log(BChart.Cid)
...
setCStime(StartTime);
setCEtime(EndTime);
axios.post("http://localhost:8080/IndBartime", {
    StartTime: StartTime,
    EndTime: EndTime,
    Cid:BChart.Cid
