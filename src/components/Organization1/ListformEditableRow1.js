...
function ListformEditableRow1({editFormData,handleEditFormChange,handleCancel}) {
  console.log(editFormData)
  return (
    <tr>
    <td>  
     <input style={{backgroundColor:'#E8F0FE'}} type="text" name="Rej_res"
      value={editFormData.Rej_res} 
     className="form-control" placeholder="Rej_res"required="text" 
...
export default ListformEditableRow1