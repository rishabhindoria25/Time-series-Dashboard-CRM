...
function DashboardEditableRow({editFormData,handleEditFormChange,handleCancel}) {
  return (
    <tr>
                         <td>
      <input style={{backgroundColor:'#E8F0FE'}} type="text" name="Dname"
       value={editFormData.Dname} 
       className="form-control" placeholder="Dashboard name"required="text" 
...
export default DashboardEditableRow