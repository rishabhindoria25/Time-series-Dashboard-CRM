...
import ListformEditableRow2 from './ListformEditableRow2';
import Listformtable2 from './Listformtable2';
...
seteditOrgid(null)
const newvalue= 'NEWTAB Adj_loss=\"'+(newEditvalueOrg.Adj_loss)+'\" '+timestamp
console.log("newvalue")
console.log(newvalue)
fetch('http://localhost:8080/Adjvalueedit', {
    method: 'POST',
    headers: {
...
const newvalueOrg= 'NEWTAB Adj_loss=\"'+(AddvalueOrg.Adj_loss)+'\" '+String(Date.now())+'000000'
...
setvalueOrg(newarticle)
fetch('http://localhost:8080/Adjvaluedelete', {
    method: 'POST',
    headers: {
      'Access-Control-Allow-Origin': '*',
      'Accept': 'application/json',
                   ...
                   {/* <form className="data"/> */}
                    ...
                    {ShowForm &&(
                      ...
                      <input type="text" name="Adj_loss"style={{backgroundColor:'#E8F0FE'}} 
                          // value={Oid} 
                         className="form-control" placeholder="Set up and Adjustment loss"required="text" 
                     ...
                     <button type="submit" 
                       ...
                       */}
                        ...
                        { valueOrg && valueOrg.map(article=>(
                          <Fragment>
                            {editOrgid===article[0]?<ListformEditableRow2 editFormData={editFormData} handleCancel={handleCancel} handleEditFormChange={handleEditFormChange}/>:<Listformtable2 article={article} handleDelete={handleDelete} handleEditclick={handleEditclick}/>}
                            {dialog.isLoading && (
                              <Dialog
                                //Update
