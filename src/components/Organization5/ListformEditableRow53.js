...
function ListformEditableRow53({aj,editFormData,handlePrdChange,handleAdjChange,handleRejChange,handleEditFormChange,handleCancel}) {
//   const VAAR=[];
...
export default ListformEditableRow53